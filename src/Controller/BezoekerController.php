...
class BezoekerController extends Controller
{
    ...
    {
        $soortactiviteitenrepository=$this->getDoctrine()->getRepository(Soortactiviteit::class);
        $soortactiviteiten=$soortactiviteitenrepository->findAll();
        $activiteitenrepository = $this->getDoctrine()->getRepository(Activiteit::class);
        $activiteiten = $activiteitenrepository->findAll();
        return $this->render('bezoeker/kartactiviteiten.html.twig', array(
            'boodschap'=>'Welkom',
