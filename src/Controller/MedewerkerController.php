...
class MedewerkerController extends Controller
{
    ...
    /**
     * @Route("/admin/details/{id}/remove/{userid}", name="removeDeelnemer")
     */
    public function removeDeelnemerAction($id, $userId)
    {
        $activiteit = $this->getDoctrine()
            ->getRepository('App:Activiteit')
            ->find($id);
    ...
    /**
     * @Route("/admin/soort/add", name="addSoort")
     */
    public function addSoortAction(Request $request)
    {
        ...
        $activiteiten=$this->getDoctrine()
            ...
            ->findAll();
        return $this->render('medewerker/soortactiviteiten.html.twig',array('form'=>$form->createView(),'naam'=>'toevoegen','aantal'=>count($activiteiten)
        ));
    }
}
